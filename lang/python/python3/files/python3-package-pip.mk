...
define Py3Package/python3-pip/install
	...
	$(CP) $(PKG_BUILD_DIR)/install-pip/opt/bin/pip$(PYTHON3_VERSION) $(1)/opt/bin
	$(LN) pip$(PYTHON3_VERSION) $(1)/opt/bin/pip3
	$(LN) pip$(PYTHON3_VERSION) $(1)/opt/bin/pip
	$(CP) \
		$(PKG_BUILD_DIR)/install-pip/opt/lib/python$(PYTHON3_VERSION)/site-packages/pip \
		$(PKG_BUILD_DIR)/install-pip/opt/lib/python$(PYTHON3_VERSION)/site-packages/pip-$(PYTHON3_PIP_VERSION).dist-info \
...
$(eval $(call Py3BasePackage,python3-pip, \
	/opt/lib/python$(PYTHON3_VERSION)/ensurepip \
	, \
