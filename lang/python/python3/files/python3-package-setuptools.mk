...
define Py3Package/python3-setuptools/install
	...
	$(LN) easy_install-$(PYTHON3_VERSION) $(1)/opt/bin/easy_install
	$(CP) \
	...
	$(CP) \
		$(1)/opt/lib/python$(PYTHON3_VERSION)/site-packages/setuptools/site-patch.py \
		$(1)/opt/lib/python$(PYTHON3_VERSION)/site-packages/setuptools/site-patch.py.txt
